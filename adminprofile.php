...
<head>
    ...
    <style>
        body{
            background:linear-gradient(to right,palevioletred,dodgerblue);
            overflow-x: hidden;
        }
        .container{
            background: #fff;
...
<form action="" method="get">
    <div class="container">
        <div class="left-box">
            <nav>
                <a onclick="tabs(0);" class="tab active" href="adminprofile.php.php"><i class="fa fa-user"></i></a>
                <a onclick="tabs(1);" class="tab active" href="adminchangepass.html"><i class="fas fa-user-lock"></i></a>
